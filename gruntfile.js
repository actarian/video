module.exports = function(grunt) {
	...
	grunt.registerTask(
		'docss',
		[ 'clean:css', 'copy:css', 'lessbootstrap', 'less:development', 'modernizr:development' ]
	);
	...
	grunt.registerTask(
		'development',
		[ 'clean:all', 'docopyDevelopment', 'lessbootstrap', 'less:development'/*, 'csslint'*/, 'stencil:development', 'devcode:development', 'prettify', 'modernizr:development', 'copy:img'/*, 'jshint:development'*/, 'connect:server', 'browser', 'watch' ]
	);

	grunt.registerTask(
		'production',
		[ 'clean:all', 'docopyProduction', 'lessbootstrap', 'less:development', 'cssmin', 'clean:removeUnusedCss', 'uglify', 'clean:removeUnusedJs', 'stencil:production', 'devcode:production', 'prettify', 'modernizr:production', 'clean:img', 'copy:img'/*, 'jshint:production'*/, 'connect:server', 'browser', 'watch' ]
	);
